...
void run(int argc, char** argv)
{
	...
	int chk = 40000000 * device_part/100;

	size_t max_size = 100000;
	size_t dummy_size = max_size * max_size * sizeof(int) - chk;
    ...
    */
    ...
    for(int i = 0; i < size-cols; i++){
        gpuWall[i] = data[i] + cols;
    }
    /*
    printf("HELLLLLLLLLLLLLLW\n");
    */
    ...
    for(int i = 0; i < cols; i++){
        result[i] = gpuResult[final_ret][i];
    }
